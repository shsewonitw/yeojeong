...
<script type="text/javascript">
	var travelList = ['${travelList.country}', '${travelList.city}', '${travelList.start_date}', '${travelList.end_date}'];
	var uniqueNames = ['${travelList.country}', '${travelList.city}', '${travelList.start_date}', '${travelList.end_date}'];
	
	$.each(travelList, function(i, el) {
